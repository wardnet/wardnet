...
function AlertModalContent({ className, container, children, ...props }: AlertModalContentProps) {
  return (
...
function AlertModalHeader({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={clsx("modal__head", className)} {...props} />;
}

type AlertModalTitleProps = Omit<React.ComponentProps<typeof AlertDialog.Title>, "asChild"> &
...
type AlertModalDescriptionProps = React.ComponentProps<typeof AlertDialog.Description>;
...
function AlertModalFooter({ className, ...props }: React.ComponentProps<"div">) {
