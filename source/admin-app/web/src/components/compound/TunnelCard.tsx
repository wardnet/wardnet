    ...
    <div className="tcard">
      ...
      >
        ...
        <dl className="tcard__grid">
          ...
          <div>
            ...
            <dd>{tunnel.last_handshake ? timeAgo(tunnel.last_handshake) : "—"}</dd>
          </div>
        </dl>
      ...
      {testResult && (
        <div className="row gap-8 rounded-[var(--radius-md)] border border-[var(--line)] bg-[var(--bg-sunken)] px-3 py-2 text-xs">
          ...
          {testedAt && <span className="ml-auto text-ink-3">tested {timeAgo(testedAt)}</span>}
        </div>
      )}
      ...
      <div className="row gap-8" style={{ justifyContent: "flex-end" }}>
        <Button size="sm" variant="outline" disabled={testTunnel.isPending} onClick={onTestClick}>
