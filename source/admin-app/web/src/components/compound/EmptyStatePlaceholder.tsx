...
export function EmptyStatePlaceholder({
  ...
  const ringOuterBorder = "color-mix(in oklab, var(--accent) 10%, transparent)";
  const ringOuterBg = "color-mix(in oklab, var(--accent) 2%, transparent)";
  const ringMidBorder = "color-mix(in oklab, var(--accent) 15%, transparent)";
  const ringMidBg = "color-mix(in oklab, var(--accent) 3%, transparent)";
  const ringInnerBorder = "color-mix(in oklab, var(--accent) 20%, transparent)";
  const ringInnerBg = "color-mix(in oklab, var(--accent) 4%, transparent)";
  const docFront = "color-mix(in oklab, var(--accent) 20%, transparent)";
  const docBack = "color-mix(in oklab, var(--accent) 10%, transparent)";
  const plusBadge = "color-mix(in oklab, var(--accent) 30%, transparent)";
          ...
          {icon ?? (
            <>
              ...
              <div className="relative">
                <FileText className="size-16" strokeWidth={1.2} style={{ color: docFront }} />
                <FileText
