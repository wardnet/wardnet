...
export function TunnelLatencyChart({ data, isLoading, isError, range, zoom, onZoomChange }: Props) {
    ...
    <Card>
      ...
      <CardContent>
        {isError ? (
          ...
          <div className="flex h-64 items-center justify-center text-sm text-ink-3">
            No latency samples yet — bring this tunnel up to start collecting probes.
          </div>
        ) : (
          ...
          >
            ...
            >
              ...
              <XAxis
                ...
                height={36}
              />
              <YAxis width={48} tick={{ fontSize: 10 }} tickFormatter={(v: number) => `${v} ms`} />
              <Tooltip
