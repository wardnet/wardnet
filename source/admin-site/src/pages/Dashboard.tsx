...
import { DashboardSecureAccessBanner } from "@/components/features/DashboardSecureAccessBanner";
...
import { useDnsStatSummary } from "@wardnet/web";
...
export default function Dashboard() {
  ...
  const activeTunnels =
    tunnelsData?.tunnels.filter((t) => t.status === "up").length ?? 0;
