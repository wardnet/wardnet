...
/**
 * Centered-card layout for unauthenticated screens (Login).
 *
 ...
 * (The first-run Setup wizard renders its own full-page shell — see
 * `pages/setup/WizardShell.tsx`.)
 */
export function AuthLayout() {
  const tagline = "Sign in to manage your network";
