...
import { AlertModalAction } from "@wardnet/web";
import {
  ProgressDialog,
  type GenericPhase,
} from "@/components/compound/ProgressDialog";
...
function contentFor(phase: RestartPhase, onSignIn: () => void): PhaseContent {
  ...
  return {
    ...
    successTitle: signedOut
      ? "Daemon restarted, session expired"
      : "Daemon is back online",
