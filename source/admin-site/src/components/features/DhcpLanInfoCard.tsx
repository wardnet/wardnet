...
import { useDnsRecords } from "@wardnet/wardnet-web";
    ...
    <Card>
      ...
      <CardContent>
        <p className="text-sm text-ink-2">
          Devices that take a DHCP lease with a hostname are automatically resolvable as{" "}
          <span className="font-mono text-xs">&#123;hostname&#125;.lan</span> in the{" "}
          <span className="font-mono text-xs">lan</span> zone. These records are managed for you and
          aren&apos;t listed under Records — revoke a lease or remove the device on the DHCP page to
          clear one.
        </p>
      </CardContent>
    </Card>
